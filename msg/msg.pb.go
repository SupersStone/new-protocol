...
func (x *MarkConversationAsReadReq) GetSenders() []string {
	if x != nil {
		return x.Senders
	}
	return nil
...
const file_msg_msg_proto_rawDesc = "" +
	...
	"\n" +
	"SendMsgReq\x12/\n" +
	"\amsgData\x18\x03 \x01(\v2\x15.openim.sdkws.MsgDataR\amsgData\"m\n" +
	"\vSendMsgResp\x12 \n" +
	...
	"hasReadSeq\x12\x12\n" +
	"\x04seqs\x18\x04 \x03(\x03R\x04seqs\x12\x18\n" +
	"\asenders\x18\x05 \x03(\tR\asenders\"\x1c\n" +
	...
	"\x1dSetConversationHasReadSeqResp\"y\n" +
	"\rDeleteSyncOpt\x12\x1e\n" +
	"\n" +
	"IsSyncSelf\x18\x03 \x01(\bR\n" +
	"IsSyncSelf\x12 \n" +
	"\vIsSyncOther\x18\x04 \x01(\bR\vIsSyncOther\x12&\n" +
	"\x0eisDelConForAll\x18\x05 \x01(\bR\x0eisDelConForAll\"\x9d\x01\n" +
	...
	"\x06maxSeq\x18\x01 \x01(\x03R\x06maxSeq\"g\n" +
	...
	"\x04seqs\x18\x01 \x03(\v2:.openim.msg.GetConversationsHasReadAndMaxSeqResp.SeqsEntryR\x04seqs\x1aI\n" +
	"\tSeqsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12&\n" +
	...
	"\rconversations\x18\x01 \x03(\v2\x1e.openim.msg.ActiveConversationR\rconversations\"\x82\x01\n" +
	"\x12AppendStreamMsgReq\x12 \n" +
	"\vclientMsgID\x18\x01 \x01(\tR\vclientMsgID\x12\x1e\n" +
	"\n" +
	"startIndex\x18\x02 \x01(\x03R\n" +
	"startIndex\x12\x18\n" +
	"\apackets\x18\x03 \x03(\tR\apackets\x12\x10\n" +
	"\x03end\x18\x04 \x01(\bR\x03end\"\x15\n" +
	"\x13AppendStreamMsgResp\"3\n" +
	"\x0fGetStreamMsgReq\x12 \n" +
	"\vclientMsgID\x18\x01 \x01(\tR\vclientMsgID\"\xe4\x01\n" +
	"\x10GetStreamMsgResp\x12 \n" +
	...
	"\x03end\x18\x05 \x01(\bR\x03end\x12\x1e\n" +
	"\n" +
	"createTime\x18\x06 \x01(\x03R\n" +
	"createTime\x12\"\n" +
	"\fdeadlineTime\x18\a \x01(\x03R\fdeadlineTime\"\x80\x01\n" +
	...
	"\tMsgsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12+\n" +
	"\x05value\x18\x02 \x01(\v2\x15.openim.sdkws.MsgDataR\x05value:\x028\x012\xd9\x17\n" +
	"\x03msg\x12D\n" +
	...
	"\aSendMsg\x12\x16.openim.msg.SendMsgReq\x1a\x17.openim.msg.SendMsgResp\x12s\n" +
	...
	"\x15GetActiveConversation\x12$.openim.msg.GetActiveConversationReq\x1a%.openim.msg.GetActiveConversationResp\x12R\n" +
	...
	"\x0eGetLastMessage\x12\x1d.openim.msg.GetLastMessageReq\x1a\x1e.openim.msg.GetLastMessageRespB)Z'github.com/SupersStone/new-protocol/msgb\x06proto3"
