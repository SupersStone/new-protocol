...
const (
	...
	Conversation_SetConversationsForAll_FullMethodName                  = "/openim.conversation.conversation/SetConversationsForAll"
...
type ConversationClient interface {
	...
	SetConversationsForAll(ctx context.Context, in *SetConversationsForAllReq, opts ...grpc.CallOption) (*SetConversationsForAllResp, error)
...
func (c *conversationClient) SetConversationsForAll(ctx context.Context, in *SetConversationsForAllReq, opts ...grpc.CallOption) (*SetConversationsForAllResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetConversationsForAllResp)
	err := c.cc.Invoke(ctx, Conversation_SetConversationsForAll_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ConversationServer interface {
	...
	SetConversationsForAll(context.Context, *SetConversationsForAllReq) (*SetConversationsForAllResp, error)
...
func (UnimplementedConversationServer) SetConversationsForAll(context.Context, *SetConversationsForAllReq) (*SetConversationsForAllResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetConversationsForAll not implemented")
}
...
func _Conversation_SetConversationsForAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetConversationsForAllReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConversationServer).SetConversationsForAll(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Conversation_SetConversationsForAll_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConversationServer).SetConversationsForAll(ctx, req.(*SetConversationsForAllReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Conversation_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetConversationsForAll",
			Handler:    _Conversation_SetConversationsForAll_Handler,
		},
		{
