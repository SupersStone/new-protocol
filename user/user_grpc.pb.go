...
func (c *userClient) UpdateReverseBlock(ctx context.Context, in *UpdateReverseBlockReq, opts ...grpc.CallOption) (*UpdateReverseBlockResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateReverseBlockResp)
	err := c.cc.Invoke(ctx, User_UpdateReverseBlock_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) UpdateReverseContact(ctx context.Context, in *UpdateReverseContactReq, opts ...grpc.CallOption) (*UpdateReverseContactResp, error) {
	...
	err := c.cc.Invoke(ctx, User_UpdateReverseContact_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _User_UpdateReverseBlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateReverseBlockReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).UpdateReverseBlock(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_UpdateReverseBlock_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).UpdateReverseBlock(ctx, req.(*UpdateReverseBlockReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _User_UpdateReverseContact_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(UserServer).UpdateReverseContact(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_UpdateReverseContact_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).UpdateReverseContact(ctx, req.(*UpdateReverseContactReq))
	}
	return interceptor(ctx, in, info, handler)
}
