...
const file_user_user_proto_rawDesc = "" +
	...
	"\x11getAllOnlineUsers\x12!.openim.user.getAllOnlineUsersReq\x1a\".openim.user.getAllOnlineUsersRespB*Z(github.com/SupersStone/new-protocol/userb\x06proto3"
