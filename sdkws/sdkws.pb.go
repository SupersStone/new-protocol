...
type GroupInfo struct {
	...
	BlockMemberCount       int32                   `protobuf:"varint,25,opt,name=blockMemberCount,proto3" json:"blockMemberCount,omitempty"`
...
type UserInfoWithEx struct {
	...
	GlobalRecvMsgOpt        *wrapperspb.Int32Value  `protobuf:"bytes,5,opt,name=globalRecvMsgOpt,proto3" json:"globalRecvMsgOpt,omitempty"`
	AllowViewLastOnlineTime *wrapperspb.Int32Value  `protobuf:"bytes,6,opt,name=allowViewLastOnlineTime,proto3" json:"allowViewLastOnlineTime,omitempty"`
	AllowSendMessages       *wrapperspb.Int32Value  `protobuf:"bytes,7,opt,name=allowSendMessages,proto3" json:"allowSendMessages,omitempty"`
	AllowVoiceCalls         *wrapperspb.Int32Value  `protobuf:"bytes,8,opt,name=allowVoiceCalls,proto3" json:"allowVoiceCalls,omitempty"`
	AllowGroupInvitations   *wrapperspb.Int32Value  `protobuf:"bytes,9,opt,name=allowGroupInvitations,proto3" json:"allowGroupInvitations,omitempty"`
...
type GroupRoomFullInfo struct {
	...
	FaceUrl       *wrapperspb.StringValue `protobuf:"bytes,10,opt,name=faceUrl,proto3" json:"faceUrl,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GroupRoomRecordTips struct {
	...
	Group                *GroupInfo             `protobuf:"bytes,1,opt,name=group,proto3" json:"group,omitempty"`
	OpUser               *GroupMemberFullInfo   `protobuf:"bytes,2,opt,name=opUser,proto3" json:"opUser,omitempty"`
	RoomInfo             *GroupRoomFullInfo     `protobuf:"bytes,3,opt,name=roomInfo,proto3" json:"roomInfo,omitempty"`
	OperationTime        int64                  `protobuf:"varint,4,opt,name=operationTime,proto3" json:"operationTime,omitempty"`
	GroupMemberVersion   uint64                 `protobuf:"varint,5,opt,name=groupMemberVersion,proto3" json:"groupMemberVersion,omitempty"`
	GroupMemberVersionID string                 `protobuf:"bytes,6,opt,name=groupMemberVersionID,proto3" json:"groupMemberVersionID,omitempty"`
...
const file_sdkws_sdkws_proto_rawDesc = "" +
	...
	"\x06UserID\x18\x01 \x01(\tR\x06UserID\x12$\n" +
	"\rcontactUserID\x18\x02 \x01(\tR\rcontactUserID\"c\n" +
